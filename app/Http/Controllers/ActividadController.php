...
class ActividadController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        $validated = $request->validate([
            ...
            'talento_detallado' => 'nullable|array',
            'talento_detallado.profesionales' => 'nullable|array',
            'talento_detallado.profesionales.*.tipo' => 'required|string|in:Subvencionado,No Subvencionado',
            'talento_detallado.profesionales.*.nombre' => 'required|string|max:255',
            'talento_detallado.profesionales.*.apellidos' => 'required|string|max:255',
            'talento_detallado.profesionales.*.ocupacion' => 'required|string|max:255',
            'talento_detallado.aficionados' => 'nullable|array',
            'talento_detallado.aficionados.*.categoria' => 'required|string|in:Generales,Municipal,Provincial,Nacional,Portador de Tradiciones',
            'talento_detallado.aficionados.*.nombre' => 'required|string|max:255',
            'talento_detallado.aficionados.*.apellidos' => 'required|string|max:255',
            'talento_detallado.aficionados.*.ocupacion' => 'required|string|max:255',
